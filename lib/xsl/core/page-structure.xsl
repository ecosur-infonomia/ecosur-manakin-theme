...
<!--Configuracion del js de shareThis-->
            ...
            <script type="text/javascript">
                stLight.options({
                        publisher:'524c4c3c-85b3-4b75-ae39-925731226c21',
                        embeds:'true',
                        onhover:'false'
                        });
            </script>
    ...
    <xsl:template name="buildHeader">
        <!--Seccion de la informacion general de ECOSUR -->
       <div id="ds-header-ecosur">
            <div id="ds-header" class="clearfix">
                <div class="logoEcosur">
                ...
                <div class="nameecosur">
                    <span id="ds-header-logo-text">EL COLEGIO </span>
                    <span id="ds-header-logo-textUnder"><span style="font-size:100%">de la </span>FRONTERA SUR</span>
                </div>                
                <div id="ds-user-box" xmlns:i18n="http://apache.org/cocoon/i18n/2.1">
                    <div class="linksEcosur">
                        <div class="linksUp">
                            <ul>
                                <li>Idioma</li><li>Contacto</li><li>Correo Institucional</li>
                            </ul>
                        </div>
                    </div>
                    <div class="linksEcosur">
                        <div class="searchEcosur">
                            <div class="input-append">
                                <input class="span2" id="appendedInputButton" type="text"/>
                                <button class="btn icon-search"  type="button" style="height:24px; margin-top:0px"></button>
                            </div>
                        </div>
                    </div>
                 </div>
        ...
        <div id="ds-trail-ecosur" xmlns:i18n="http://apache.org/cocoon/i18n/2.1">
            <ul id="ds-trail">
                <li class="ds-trail-link first-link last-link">Quiénes Somos</li>
                <li class="ds-trail-link first-link last-link">Unidades</li>
                <li class="ds-trail-link first-link last-link">Investigación</li>
                <li class="ds-trail-link first-link last-link">Vinculación</li>
                <li class="ds-trail-link first-link last-link">Posgrado</li>
                <li class="ds-trail-link first-link last-link">Biblioteca</li>
                <li class="ds-trail-link first-link last-link">Transparencia</li>
            </ul>
        </div>
    ...
    <xsl:template name="buildTrail">
        <div id="ds-trail-wrapper">
            <div id="ds-content-rie" class="clearfix">
                <ul id="ds-trail">
                    <xsl:choose>
                        <xsl:when test="starts-with($request-uri, 'page/about')">
                             <xsl:text>About This Repository</xsl:text>
   ...
   <xsl:if test="$ccLicenseName and $ccLicenseUri and contains($ccLicenseUri, 'creativecommons')">
    ...
    <xsl:template name="buildFooter">
       ...
       <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <!--Funcion que valida el URL para hacer ciertas funciones con javascript IOG -->
                            <script type="text/javascript">
                                <xsl:attribute name="src">
                                    <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
                                    <xsl:text>/themes/</xsl:text>
